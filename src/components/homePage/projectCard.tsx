...
export default function ProjectCard(props: {
    ...
    return (
        <div className="group w-full flex flex-col md:grid md:grid-cols-5 md:gap-5 gap-2 rounded">
            <div className="col-span-2 relative overflow-hidden h-[250px]">
                <div className="flex items-center justify-center transition-all w-full h-full absolute bottom-[-100%] group-hover:bottom-0 bg-gradient-to-t rounded border-t-2 border-zinc-600 from-black to-sky-700/30">
